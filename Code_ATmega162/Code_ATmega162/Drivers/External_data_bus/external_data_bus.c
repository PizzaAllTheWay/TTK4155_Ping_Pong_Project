...
char external_data_bus_read(uint16_t address) {
	...
	// This pull down still takes too long time to discharge, so we need to add this delay in order for signals to discharge before each data transferr
