...
def main():
    ...
    bytes_to_read = 8   # joystick y, joystick x, pad left, pad right, joy_btn, left_btn, right_btn
    ...
    try:
        ...
        update_plotting(data_buffer, data_lock)
